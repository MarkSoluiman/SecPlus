...
A user starts with $2000 in their bank account. If they tried to withdraw two different amounts simultaneously like $1000 and $1500, the bank server will not have time to process the first request and it will proceed with the second withdraw request without checking first for the balance. This will result in the user's bank account to go to a negative value of $-500.   
