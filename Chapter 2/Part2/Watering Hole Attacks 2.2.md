...
To perform a watering hole attack, the attacker has to determine what websites the victim group uses, for example,industry-related sites. The attacker will then infect one of these third-party sites with site vulnerabilities or email attachments.
