...
Security zones allow us to logically separate all of the devices on a network by their user or their access type. Each section of the network will be assigned a zone. For example, we might have a trusted and an untrusted zone, an internal and an external zone, and other types of zones like inside, servers, databases, etc. 
